...
namespace ConstellationSketch.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public int IncludeStars { get; set; } = 0;
        ...
        public IActionResult OnPostDownloadSketch()
        {
            ...
            var pdfBytes = SketchRenderer.Render(headerMarkdown, constellationName, result.CenterAltDegrees, result.CenterAzDegrees, observationTime, IncludeStars, result.PngBytes);
